...
function getVulnerableServices() {
    return __awaiter(this, void 0, void 0, function () {
        var detectorId, config, guardduty, findings, vulnerableServices_1, findingIds, promises, findingDetailsArray, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
program
    ...
    var list, s3Alerts, answer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getListOfServices()];
            case 1:
                list = _a.sent();
                s3Alerts = list.map(function (item, index) { return ({
                    value: index,
                    name: "[".concat(item.type, "]: ").concat(item.title),
                }); });
